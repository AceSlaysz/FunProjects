...
function handleButtonClick() {
  ...
  button.innerText = randomTaunt; // Show a taunt when clicked
...
function nextLevel() {
  if (currentLevel < 3) {
    ...
    // Lightning round: Must click within 5 seconds (you can change this value to your liking)
    clearTimeout(gameTimer);
    gameTimer = setTimeout(playLoseVideo, 5000); // 5000ms = 5 seconds
  }
}
